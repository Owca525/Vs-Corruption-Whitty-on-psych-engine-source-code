...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Port Creator'],
			["Owca525",             'Owca525',           'Creat Port mod on psych engine',                        'https://www.youtube.com/channel/UCtfqELKVzoA-avF9IdpSDCg', '00CC00'],
			[''],
			['Orginal Mod Creator'],
			['Shadorot',            'Shadorot',          'Creator mod',                                           'https://www.youtube.com/channel/UC8MBcasii-7cPtozHKCdmvA', 'CC0000'],
			[''],
			['Psych Engine Team'],
